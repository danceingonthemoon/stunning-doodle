...
def add_to_trolley(item):
    ...
    shopping_trolley.append([new_category, new_item])
    print(f"{new_item} has been added to the shopping trolley in the new '{new_category}' category.")
...
def remove_items_of_shopping_list(item):
    display_shopping_list()
