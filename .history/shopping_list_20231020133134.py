...
def add_to_trolley():
    ...
    if category in shopping_trolley:
        print(
            f"{item} has been added to the shopping trolley in the '{category}' category.\n")
        return
    print(
        f"No such category '{category}' exists. Creating a new category.")
    shopping_trolley.append([category, item])
    print(f"{item} has been added to the shopping trolley in the new '{category}' category.")
